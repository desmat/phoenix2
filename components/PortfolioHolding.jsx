  ...
  render() {
    return (     
      <tr onClick={this.select} className={this.props.data.updatedUp ? "flash-green drilldownable" : this.props.data.updatedDown ? "flash-red drilldownable" : "drilldownable"}>
        ...
        <td className={this.props.data.sharesPreview ? "text-right text-preview" : this.props.data.dirty ? "text-right text-muted" : "text-right"}>{this.props.data.sharesPreview ? this.props.data.sharesPreview : this.props.data.shares}</td>
        ...
        <td className={this.props.data.valuePreview ? "text-right text-preview" : this.props.data.dirty ? "text-right text-muted" : "text-right"}>${this.props.data.valuePreview ? this.props.data.valuePreview : this.props.data.value}</td>
