  ...
  render() {
    return (     
      <tr onClick={this.select} className={this.props.data.updatedUp ? "flash-green drilldownable" : this.props.data.updatedDown ? "flash-red drilldownable" : "drilldownable"}>
        ...
        <td className={this.props.data.dirty ? "text-right text-muted" : "text-right portfolio-holding-shares-" + this.props.data.id}>{this.props.data.shares}</td>
        ...
        <td className={this.props.data.dirty ? "text-right text-muted" : "text-right portfolio-holding-value-" + this.props.data.id}>${this.props.data.value}</td>
